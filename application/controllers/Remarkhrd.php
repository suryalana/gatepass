...
class Remarkhrd extends CI_Controller
{
    ...
    function index()
    {
        ...
        if (!empty($username)) {
            $data['list'] = $this->Mremarkhrd->get_employee();
    ...
    function remarkhrd()
    {
        ...
        if (!empty($username)) {
            $data['list'] = $this->Mremarkhrd->get_employee();
            $data['list_remark'] = $this->Mremarkhrd->get_remark();
            $this->load->view('data/index_header_template', $data);
            $this->load->view('data/remarkhrd', $data);
            $this->load->view('data/index_footer_template', $data);
        } else {
    ...
    {
        $id = $this->input->post('id', TRUE);
        $list = $this->Mremarkhrd->getEditemployee($id);
?>
